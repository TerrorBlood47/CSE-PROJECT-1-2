...
void levelOneWindowLoad(void)
{
    ...
    SDL_QueryTexture(levelOneWindowCharacter.tex, NULL, NULL, &L1CharTexturewidth, &L1CharTextureheight);
    L1CharFramewidth = L1CharTexturewidth / 4 + 1;
    L1CharFrameheight = L1CharTextureheight / 2;
    levelOneWindowCharacter.rect.w = L1CharFramewidth;
    levelOneWindowCharacter.rect.h = L1CharFrameheight;
    levelOneWindowCharacter.rect.x = 0;
    levelOneWindowCharacter.rect.y = 0;
    characterFramePosition.rect.w = L1CharFramewidth - 140; // character sprite mota hoy plus korle, cikon hoy minus korle
    characterFramePosition.rect.h = L1CharFrameheight - 180;
