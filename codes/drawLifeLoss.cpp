...
void lifeUpdateAnimation()
{
    ...
    levelOneLifeAnimationSpeed[0] -= 5;
    ...
    levelOneLifeAnimationSpeed[1] -= 5;
    ...
    levelOneLifeAnimationSpeed[2] -= 5;
    ...
    levelOneLifeAnimationSpeed[3] -= 3;
    if (levelOneLifeAnimationSpeed[3] < 10)
    {
        levelOneLifeAnimationSpeed[3] = 700;
        levelOneLifeLoss[3].rect.w = (int)0;
        levelOneLifeLoss[3].rect.h = (int)0;
    }
}
